...
By default, if you are monitoring the alert.log, and there have
been any errors in the last day a WARNING is flagged, and within 
the last hour, an ALERT.  In addition, if you have your config
